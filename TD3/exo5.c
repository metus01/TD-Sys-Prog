...
{
  struct tm *date_object =  localtime(&time);
...
int main (void)
{
  ...
  printf("Le jour du mois : %d" , current_day.day);
  printf("Le jour de la semaine : %d",current_day.weekday);
  printf("Le mois est : %d" , current_day.month);
  printf("De l'an : %d" , current_day.year);
}